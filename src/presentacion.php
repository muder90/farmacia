                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="nombre" class="text-dark font-weight-bold"><B>NOMBRE DE LA PRESENTACIÓN </b></label>
                                <input type="text" placeholder="Ingrese Nombre de la presentación" name="nombre" id="nombre" class="form-control">
                                <input type="hidden" name="id" id="id">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="nombre" class="text-dark font-weight-bold"><B>NOMBRE CORTO</B></label>
